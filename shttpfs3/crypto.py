...
#===============================================================================
def unlock_private_key(private_key: str) -> bytes:
    private_key: bytes = base64.b64decode(private_key)
    ...
    if private_key[0] == b'y':
        ...
        private_key: bytes = pysodium.crypto_secretbox_open(cyphertext, nonce, key)
        return private_key
    else:
